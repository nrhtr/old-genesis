...
var $http_interface bytes = 0;
var $http_interface cache = [];
var $http_interface ctype = "text/html";
var $http_interface full = 1;
var $http_interface header = #[:interface => $http_interface];
...
var $http_interface status = 200;
var $root child_index = 1175;
