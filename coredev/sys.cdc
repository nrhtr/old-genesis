...
var $sys backup = #[:interval => 3600, :last => 1322648812, :next => 1322653078];
...
var $sys startup = #[:objects => [$login_daemon, $http_daemon, $smtp_daemon, $netquery_daemon, $finger_daemon, $world, $dns, $lag_watcher], :heartbeat_interval => 2, :time => 1322649478];
