...
public method .broadcast() {
    ...
    if (((msg[1]) == "'") || ((msg[1]) == "-")) {
        ...
        //FIXME: should we really be using exceptions here? or should we change subrange's behaviour. not sure
        catch ~range
    ...
    // $#Edited: 26 Nov 11 19:01 $user_celthric
    // $#Edited: 26 Nov 11 19:02 $user_celthric
    // $#Edited: 26 Nov 11 19:05 $user_celthric
    // $#Edited: 26 Nov 11 21:12 $user_celthric
};
