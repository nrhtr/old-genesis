...
var $scheduler task_index = 3;
var $scheduler task_queue = [[2, 1322649759, 1322649459, $housekeeper, $housekeeper, :move_user_home, [:system], [$user_celthric]], [3, 1322649794, 1322649494, $housekeeper, $housekeeper, :move_user_home, [:system], [$user_celthric]]];
